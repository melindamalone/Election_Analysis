...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in county_name_list:
            ...
            # 4b: Add the existing county to the list of county_name_list.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name_list in county_votes_dict:
        # 6b: Retrieve the county vote count.
        total_county_votes = county_votes_dict.get(county_name_list)
        # 6c: Calculate the percentage of votes for the county.
        county_vote_percentage = float(total_county_votes) / float(total_votes) * 100
        county_results = (
            f"{county_name_list}: {county_vote_percentage:.1f}% ({total_county_votes:,})\n")
        ...
        if (total_county_votes > winning_county_votes) and (county_vote_percentage > winning_county_percentage):
            total_county_votes = winning_county_votes
            winning_county = county_name_list
